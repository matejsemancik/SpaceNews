...
>: View {
    ...
    private let kotlinStackFlow: SkieSwiftStateFlow<ChildStack<Destination, Entry>>
    @State private var kotlinStack: ChildStack<Destination, Entry>
    ...
    init(
        ...
        self.kotlinStackFlow = kotlinStack
        self.kotlinStack = kotlinStack.value
    ...
    var body: some View {
        ...
        .task {
            for await stack in kotlinStackFlow {
                self.kotlinStack = stack
            }
        }
    }
}
